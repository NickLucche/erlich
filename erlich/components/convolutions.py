...
def separable_conv(in_ch, out_ch=0, size=3, stride=1, normalization=None, activation="relu", pad: (int, str) = "same"):
    if pad == "same":
        padding = size // 2
    else:
        padding = int(pad)
...
def conv(in_ch, out_ch=0, size=3, stride=1, normalization=None, activation="relu", pad: (int, str) = "same"):
    if pad == "same":
        padding = size // 2
    else:
        padding = int(pad)
